...
export declare function StoreContainer<S = any, W extends WidgetBase<any, any> = WidgetBase<any, any>>(component: Constructor<W> | RegistryLabel, name: RegistryLabel, {paths, getProperties}: StoreContainerOptions<S, W>): StoreContainer<W>;
/**
 * Creates a typed `StoreContainer` for State generic.
 */
export declare function createStoreContainer<S>(): <W extends WidgetBase<any, any>>(component: string | symbol | Constructor<W>, name: string | symbol, {paths, getProperties}: StoreContainerOptions<S, W>) => Constructor<WidgetBase<Partial<W["properties"]>, W["children"][0]>>;
