(function (factory) {
    ...
    function xhr(url, options) {
        ...
        var _a = options.credentials, credentials = _a === void 0 ? 'same-origin' : _a;
        ...
        var _b = options.includeRequestedWithHeader, includeRequestedWithHeader = _b === void 0 ? true : _b, _c = options.includeUploadProgress, includeUploadProgress = _c === void 0 ? true : _c;
        if (options.headers) {
            ...
            try {
                for (var requestHeaders_1 = tslib_1.__values(requestHeaders), requestHeaders_1_1 = requestHeaders_1.next(); !requestHeaders_1_1.done; requestHeaders_1_1 = requestHeaders_1.next()) {
                    var _d = tslib_1.__read(requestHeaders_1_1.value, 2), key = _d[0], value = _d[1];
                ...
                try {
                    if (requestHeaders_1_1 && !requestHeaders_1_1.done && (_e = requestHeaders_1.return)) _e.call(requestHeaders_1);
                }
